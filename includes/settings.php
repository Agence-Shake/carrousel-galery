...
function cg_render_edit_page() {
    ...
    <div class="wrap cg-wrap">
        ...
        <form method="post" action="options.php" class="cg-form" style="margin-top:20px;">
            ...
            <section class="cg-card">
                ...
                <div class="cg-card-body">
                    <table class="form-table cg-colors">
                        <tr><th>Bullet inactif</th><td><?php cg_render_color( $preset_opt . '[color_bullet]', $s['color_bullet'] ); ?></td></tr>
                        <tr><th>Bullet actif</th><td><?php cg_render_color( $preset_opt . '[color_bullet_active]', $s['color_bullet_active'] ); ?></td></tr>
                        <tr><th>Flèche</th><td><?php cg_render_color( $preset_opt . '[color_arrow]', $s['color_arrow'] ); ?></td></tr>
                        <tr><th>Flèche au survol</th><td><?php cg_render_color( $preset_opt . '[color_arrow_hover]', $s['color_arrow_hover'] ); ?></td></tr>
                        <tr><th>Fond du carrousel</th><td><?php cg_render_color( $preset_opt . '[color_bg]', $s['color_bg'] ); ?></td></tr>
                    </table>
                </div>
            </section>
            ...
            <div class="cg-actions">
                ...
                <a href="<?php echo esc_url( admin_url( 'admin.php?page=carrousel-galerie' ) ); ?>" class="button button-secondary" style="margin-left:10px;">Annuler</a>
            </div>
        </form>
    </div>
    <?php
